...
export const LoginScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-canvas-bg flex items-center justify-center p-4 relative overflow-hidden transition-all duration-300">
      ...
      <div className="w-full max-w-md bg-card-bg border border-card-border-custom shadow-card rounded-card p-8 sm:p-10 flex flex-col items-center text-center relative z-10 transition-all duration-300">
        ...
        {/* Welcome Text */}
        <p className="text-xs text-text-muted font-bold mb-8 max-w-[280px] leading-relaxed uppercase tracking-wider">
          Log in with Google to synchronize your habits, deep work focus sessions, and targets.
        </p>

        {/* System Features Highlights Showcase */}
        <div className="w-full flex flex-col gap-4 mb-8 text-left bg-slate-50-custom dark:bg-slate-800/30 p-5 rounded-2xl border border-card-border-custom/40">
        ...
        {/* Footer */}
        <span className="text-[8px] text-brand-grey font-black uppercase tracking-widest mt-8 select-none">
